    ...
    <Components.Generic.Popover.Root>
      <Components.Generic.Popover.Trigger>
        <Components.FormattingToolbar.Button
          className={'bn-button'}
          label={dict.formatting_toolbar.file_rename.tooltip[fileBlock.type] || dict.formatting_toolbar.file_rename.tooltip['file']}
          mainTooltip={dict.formatting_toolbar.file_rename.tooltip[fileBlock.type] || dict.formatting_toolbar.file_rename.tooltip['file']}
          icon={<RiFontFamily />}
        />
      </Components.Generic.Popover.Trigger>
