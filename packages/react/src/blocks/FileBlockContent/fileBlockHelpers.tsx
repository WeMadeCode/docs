...
export const ResizeHandlesWrapper = (
  ...
  return (
    <div className={'bn-visual-media-wrapper'} onMouseEnter={childWrapperMouseEnterHandler} onMouseLeave={childWrapperMouseLeaveHandler}>
      {props.children}
      {(childHovered || resizeParams) && (
        <>
          <div className={'bn-visual-media-resize-handle'} style={{ left: '4px' }} onMouseDown={leftResizeHandleMouseDownHandler} />
          <div className={'bn-visual-media-resize-handle'} style={{ right: '4px' }} onMouseDown={rightResizeHandleMouseDownHandler} />
        </>
      )}
    </div>
  )
