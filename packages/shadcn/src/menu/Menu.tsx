...
export const Menu = (props: ComponentProps['Generic']['Menu']['Root']) => {
  ...
  if (sub) {
    return (
      <ShadCNComponents.DropdownMenu.DropdownMenuSub onOpenChange={onOpenChange}>{children}</ShadCNComponents.DropdownMenu.DropdownMenuSub>
    )
  } else {
    return <ShadCNComponents.DropdownMenu.DropdownMenu onOpenChange={onOpenChange}>{children}</ShadCNComponents.DropdownMenu.DropdownMenu>
  }
}
